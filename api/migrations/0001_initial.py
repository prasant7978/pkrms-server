# Generated by Django 5.0.7 on 2025-02-11 19:51
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role_name', models.CharField(choices=[('superadmin', 'Super Admin'), ('pfid', 'PFID'), ('dpsi', 'DPSI'), ('spdjd', 'SPDJD'), ('balai_lg', 'Balai LG'), ('provience_lg', 'Provincial LG'), ('kabupaten_lg', 'Kabupaten LG')], default='pfid', max_length=20, unique=True, verbose_name='Role')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kabupaten', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='api.kabupaten')),
                ('class_field', models.ForeignKey(blank=True, db_column='class', null=True, on_delete=django.db.models.deletion.CASCADE, to='api.linkclass')),
                ('function', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='api.linkfunction')),
                ('status', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='api.linkstatus')),
                ('province', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='api.province')),
            ],
            options={
                'db_table': 'Link',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('drainL', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='road_condition_left', to='api.draincondition')),
                ('drainR', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='road_condition_right', to='api.draincondition')),
                ('footpathL', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='road_condition_footpath_left', to='api.footpathcondition')),
                ('footpathR', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='road_condition_footpath_right', to='api.footpathcondition')),
                ('linkId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='road_conditions', to='api.link')),
                ('shoulderL', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='road_condition_shoulder_left', to='api.shouldercondition')),
                ('shoulderR', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='road_condition_shoulder_right', to='api.shouldercondition')),
                ('slopeL', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='road_condition_slope_left', to='api.slopecondition')),
                ('slopeR', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='road_condition_slope_right', to='api.slopecondition')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('drainTypeL', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='road_inventory_left', to='api.draintype')),
                ('drainTypeR', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='road_inventory_right', to='api.draintype')),
                ('impassableReason', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='road_inventory', to='api.impassible')),
                ('landUseL', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='road_inventory_left', to='api.landuse')),
                ('landUseR', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='road_inventory_right', to='api.landuse')),
                ('linkId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='road_inventory', to='api.link')),
                ('shoulderTypeL', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='road_inventory_left', to='api.shouldertype')),
                ('shoulderTypeR', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='road_inventory_right', to='api.shouldertype')),
                ('terrain', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='road_inventory', to='api.terrain')),
            ],
            options={
